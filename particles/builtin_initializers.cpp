			...
			case PARTICLEBLEND_OVERLAY:
				{
					while( n_blocks-- )
					{
						...
						fvColor += fvColorMin;
						//Do Blend
						fltx4 fl4BlendMaskRed = CmpLtSIMD( fvTint.x, Four_PointFives );
						fltx4 fl4BlendMaskGreen = CmpLtSIMD( fvTint.y, Four_PointFives );
						fltx4 fl4BlendMaskBlue = CmpLtSIMD( fvTint.z, Four_PointFives );
		...
		void *pContext ) const
{
	...
	while( n_blocks-- )
	{
		...
		fltx4 fl4PassMask = CmpGeSIMD( fl4Life, Four_Zeros );
		fltx4 fl4SkipMask = CmpLtSIMD( fl4Life, Four_Zeros );
		if ( IsAnyNegative( fl4PassMask ) )
		{
			// Determine Velocity
			...
			fltx4 fl4InvalidMask = CmpEqSIMD( v4PointOnPlane.x, fvInvalid.x );
						...
						void *pContext ) const
{
	...
	if ( m_bUseVelocity )
	{
		...
		while( n_blocks-- )
		{
			...
			fltx4 fl4SkipMask = CmpEqSIMD( fl4Lifespan, Four_NegativeOnes );
