...
BEGIN_DMXELEMENT_UNPACK( CParticleSystemDefinition ) 
	...
	DMXELEMENT_UNPACK_FIELD_STRING_USERDATA( "material", "vgui/white", m_MaterialName, "vmtPicker" )
	...
	DMXELEMENT_UNPACK_FIELD_STRING( "cull_replacement_definition", "", m_CullReplacementName )
	DMXELEMENT_UNPACK_FIELD_STRING( "fallback replacement definition", "", m_FallbackReplacementName )
...
// Is the particle system two-pass?
//-----------------------------------------------------------------------------
bool CParticleCollection::IsParticleSystemTwoPass() const
{
	return m_bIsTwoPass;
}
